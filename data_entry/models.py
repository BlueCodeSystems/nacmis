...
class GeoSupportView(models.Model):
...
#This is a view
class Geosupport(models.Model):
    #id = models.IntegerField(blank=True, null=True)
    organisation = models.CharField(max_length=200, blank=True, null=True)
    organisation_address = models.CharField(max_length=100, blank=True, null=True)
    start_year = models.DateField(blank=True, null=True)
    gps = models.CharField(max_length=20, blank=True, null=True)
    website = models.CharField(max_length=200, blank=True, null=True)
    description_of_organisation = models.TextField(blank=True, null=True)
    key_contact_name = models.CharField(max_length=50, blank=True, null=True)
    position_within_organisation = models.CharField(max_length=50, blank=True, null=True)
    telephone_number = models.CharField(max_length=128, blank=True, null=True)
    telephone_number_alternative = models.CharField(max_length=128, blank=True, null=True)
    email_address = models.CharField(max_length=254, blank=True, null=True)
    permanent_employee_female = models.IntegerField(blank=True, null=True)
    permanent_employee_male = models.IntegerField(blank=True, null=True)
    temporary_employee_female = models.IntegerField(blank=True, null=True)
    temporary_employee_male = models.IntegerField(blank=True, null=True)
    volunteer_employee_female = models.IntegerField(blank=True, null=True)
    volunteer_employee_male = models.IntegerField(blank=True, null=True)
    organisation_type = models.CharField(max_length=100, blank=True, null=True)
    national_organisation_id = models.IntegerField(blank=True, null=True)
    organisation_district_id = models.IntegerField(blank=True, null=True)
    area_of_support = models.CharField(max_length=100, blank=True, null=True)
    ...
    district_latitude = models.CharField(max_length=50, blank=True, null=True)
    district_longitude = models.CharField(max_length=50, blank=True, null=True)
